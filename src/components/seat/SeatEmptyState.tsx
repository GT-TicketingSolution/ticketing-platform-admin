...
interface SeatEmptyStateProps {
  onCreateSeat: () => void;
}

export default function SeatEmptyState({ onCreateSeat }: SeatEmptyStateProps) {
  return (
    <div
      style={{
      ...
      className="seat-empty-container"
    >
      {/* Ferris Wheel + Fort Illustration SVG matching Figma Screenshot */}
      <div
        style={{
          width: "100%",
          maxWidth: "403px",
      ...
      >
        ...
        >
          ...
          <rect x="120" y="105" width="140" height="60" stroke="#94A3B8" strokeWidth="1.5" fill="#FFFFFF" />
      ...
      {/* Main Title - matching exact style */}
      <h2
        style={{
      ...
      >
        You haven’t added any seat layouts yet. Configure a new seating arrangement
